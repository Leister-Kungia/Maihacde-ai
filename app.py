    ...
    def event_stream():
        ...
        try:
            ...
            # ── Nhánh text thuần ─────────────────────────────────────────
                ...
                agent_names = {
                    "diem_chuan":   "điểm xét tuyển lớp 10",
                    "truong":       "thông tin trường MHĐ",
                    "tuyen_sinh":   "quy trình tuyển sinh",
                    "hoc_tap":      "chương trình học",
                    "huong_nghiep": "định hướng sau THPT",
                    "kien_thuc":    "kiến thức học tập",
                }
